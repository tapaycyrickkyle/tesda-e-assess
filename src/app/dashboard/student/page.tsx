...
const navLinkClass =
  "flex items-center gap-3 rounded-lg px-4 py-2 text-[14px] font-semibold text-[#444653] transition hover:bg-[#e5eeff] hover:text-[#002576]";

export default function StudentDashboardPage() {
  return (
    <div className="min-h-screen bg-[#f8f9ff] text-[#0b1c30]">
      <header className="fixed left-0 top-0 z-40 flex h-16 w-full items-center justify-between border-b border-[#c4c5d5] bg-white px-4 shadow-sm sm:px-6">
        <div className="flex items-center gap-6">
          <span className="text-[24px] font-bold leading-none text-[#002576]">TESDA E-Assess</span>
          <nav className="hidden items-center gap-3 md:flex">
            <span className="border-b-2 border-[#002576] px-2 py-5 text-[14px] font-bold text-[#002576]">Dashboard</span>
            <span className="px-2 py-5 text-[14px] font-semibold text-[#5d5f5f]">Applications</span>
            <span className="px-2 py-5 text-[14px] font-semibold text-[#5d5f5f]">Evaluations</span>
          </nav>
        </div>

        <div className="flex items-center gap-2 sm:gap-3">
          <button className="flex h-9 w-9 items-center justify-center rounded-full text-[#5d5f5f] transition hover:bg-[#e5eeff] hover:text-[#002576]" type="button">
            <i aria-hidden="true" className="fa-regular fa-bell text-[16px]" />
          </button>
          <button className="flex h-9 w-9 items-center justify-center rounded-full text-[#5d5f5f] transition hover:bg-[#e5eeff] hover:text-[#002576]" type="button">
            <i aria-hidden="true" className="fa-solid fa-gear text-[15px]" />
          </button>
          <div className="ml-1 hidden items-center gap-2 border-l border-[#c4c5d5] pl-3 sm:flex">
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#dce1ff] text-[13px] font-bold text-[#002576]">
              MD
            </div>
            <button className="text-[14px] font-semibold text-[#002576] transition hover:underline" type="button">
              Logout
            </button>
          </div>
        </div>
      ...
      <aside className="fixed left-0 top-16 hidden h-[calc(100vh-4rem)] w-64 flex-col border-r border-[#c4c5d5] bg-[#f8f9ff] px-3 pb-4 pt-5 lg:flex">
        <button className="mb-5 flex items-center justify-center gap-2 rounded-lg bg-[#0038a8] px-4 py-3 text-[14px] font-semibold text-white transition hover:bg-[#002576]" type="button">
          <i aria-hidden="true" className="fa-solid fa-plus text-[12px]" />
          New Assessment
        </button>

        <nav className="space-y-1">
          <a className="flex items-center gap-3 rounded-r-lg border-l-4 border-[#002576] bg-[#dce1ff] px-3 py-2 text-[14px] font-bold text-[#093cab]" href="#">
            <i aria-hidden="true" className="fa-solid fa-table-columns text-[14px]" />
            Dashboard
          </a>
          <a className={navLinkClass} href="#">
            <i aria-hidden="true" className="fa-regular fa-file-lines text-[14px]" />
            Applications
          </a>
          <a className={navLinkClass} href="#">
            <i aria-hidden="true" className="fa-solid fa-user-check text-[14px]" />
            Verification
          </a>
          <a className={navLinkClass} href="#">
            <i aria-hidden="true" className="fa-regular fa-star text-[14px]" />
            Evaluations
          </a>
          <a className={navLinkClass} href="#">
            <i aria-hidden="true" className="fa-solid fa-chart-line text-[14px]" />
            Reports
          </a>
          <a className={navLinkClass} href="#">
            <i aria-hidden="true" className="fa-solid fa-sliders text-[14px]" />
            System Settings
          </a>
        </nav>

        <div className="mt-auto border-t border-[#c4c5d5] pt-3">
          <a className={navLinkClass} href="#">
            <i aria-hidden="true" className="fa-regular fa-circle-question text-[14px]" />
            Help Center
          </a>
          <a className={navLinkClass} href="#">
            <i aria-hidden="true" className="fa-regular fa-user text-[14px]" />
            Account Settings
          </a>
        </div>
      </aside>

      <main className="px-4 pb-8 pt-20 sm:px-6 lg:ml-64 lg:px-8">
