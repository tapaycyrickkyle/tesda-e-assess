...
export default function TeacherTypePage() {
  return (
    <main className="min-h-screen bg-[#f3f4fa] px-6 py-16 text-[#0b1c30]">
      <div className="mx-auto w-full max-w-5xl">
        <h1 className="mb-2 text-center text-5xl font-bold tracking-tight text-[#0d2f86]">
          Choose Teacher Type
        </h1>
        <p className="mx-auto mb-10 max-w-2xl text-center text-2xl text-[#444653]">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          >
            ...
            <h2 className="mb-3 text-4xl font-bold text-[#0d2f86]">Public Teacher</h2>
            <p className="mb-6 text-xl text-[#444653]">
          ...
          >
            ...
            <h2 className="mb-3 text-4xl font-bold text-[#0d2f86]">Private Teacher</h2>
            <p className="mb-6 text-xl text-[#444653]">
