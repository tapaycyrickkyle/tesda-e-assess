    ...
    <main className="ui-portal-main pb-24 pt-6">
      <div className="ui-page-content">
        <section className="mb-5">
          <h1 className="text-[34px] font-bold leading-[1.15] text-[#002576]">Assessment Rooms</h1>
      ...
      <AnimatedModal
        contentClassName="w-full max-w-[620px] rounded-[12px] border border-[#d9e3f7] bg-white p-4 shadow-[0_12px_30px_rgba(15,23,42,0.12)] sm:p-4"
      ...
      <AnimatedModal
        contentClassName="w-full max-w-[420px] rounded-[12px] border border-[#d9e3f7] bg-white p-4 shadow-[0_12px_30px_rgba(15,23,42,0.12)]"
      ...
      >
        {createdRoom ? (
          <>
            ...
            <div className="rounded-[12px] border border-[#d9e3f7] bg-[#f8fbff] p-4">
              <div>
              ...
              <div className="mt-4 rounded-[10px] border border-[#cfe0ff] bg-white p-3.5 shadow-[0_1px_2px_rgba(15,23,42,0.05)]">
