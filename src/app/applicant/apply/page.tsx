...
function ApplicationPathCard({ description, href, icon, onClick, title }: ApplicationPathCardProps) {
  ...
  return (
    <Link className={className} href={href ?? "/applicant/apply"}>
      {content}
    </Link>
  );
}
    ...
    <main className="ui-portal-main pb-8 pt-8">
      <div className="ui-page-content">
        <section className="ui-page-header">
          <h1 className="ui-page-title text-[#002576]">Apply</h1>
      ...
      <AnimatedModal
        contentClassName="w-full max-w-[560px] rounded-xl border border-[#d9e3f7] bg-white p-4 shadow-[0_12px_30px_rgba(15,23,42,0.12)] sm:p-7"
