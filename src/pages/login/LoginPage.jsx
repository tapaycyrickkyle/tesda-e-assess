    ...
    <div className="flex min-h-screen flex-col bg-slate-100 text-slate-900">
      ...
      <main className="mx-auto mb-14 w-full max-w-screen-2xl flex-1 px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section className="mx-auto max-w-6xl overflow-hidden rounded-[30px] bg-white shadow-[0_20px_55px_rgba(15,23,42,0.12)]">
          <div className="grid lg:min-h-[680px] lg:grid-cols-[0.82fr_1.18fr]">
              ...
              <div className="mx-auto max-w-3xl">
                ...
                <form className="mt-12 space-y-6">
                  ...
                  <div className="flex flex-col items-start justify-between gap-2 sm:flex-row sm:items-center">
                    <span className="block text-base font-semibold text-slate-700 sm:text-lg">
                      Password
                    </span>
                    <a
                      href="#"
                ...
                <p className="mt-6 text-center text-base text-slate-600 sm:text-lg">
