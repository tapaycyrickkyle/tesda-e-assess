...
const AssessmentCenterDashboardHeader = () => {
  return (
    <header className="flex flex-col gap-3 border-b border-slate-200 bg-white px-4 py-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
      <div className="flex flex-1 items-center gap-4">
        <label className="relative w-full max-w-xl">
          ...
          <input
            type="search"
            placeholder="Search applicants, courses, or IDs..."
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        <button
          type="button"
          className="relative inline-flex h-10 w-10 items-center justify-center rounded-full text-slate-500 transition hover:bg-slate-100"
        ...
        <h2 className="hidden text-sm font-semibold text-slate-700 md:block">Assessment Management System</h2>
      </div>
    </header>
  );
};

export default AssessmentCenterDashboardHeader;
